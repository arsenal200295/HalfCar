function [Zdot] = HalfCarModel5(t,z,hcar)
...
tha1 = -hyp1*(za1 - init(3));
tha2 = hyp2*(za2 - init(4));
...
fnetv1 = fkt1 + fdt1  + fz1_u + fnsm - fga1 - fs1 - fd1;
fnetv2 = fkt2 + fdt2  + fz2_u - fnsm - fga2 - fs2 - fd2;
