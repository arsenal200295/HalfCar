function [Zdot] = HalfCarModel8(t,z,hcar)
%HALFCARMODEL4 ITERATION 7 -  Half Car Model to be called by the Numerical Integrator
%   *NEW - Attempt to solve the Omega<0 during braking problem
...
hypCP1 = hcar.axleSusp.hyp_1;
hypCP2 = hcar.axleSusp.hyp_2;
...
tha1 = -(za1 - init(3))/hypCP1;
tha2 = (za2 - init(4))/hypCP2;
...
Iapc1 = hcar.Inertia_NSM_1 + hcar.mass_usm_1*hypCP1^2;
Iapc2 = hcar.Inertia_NSM_2 + hcar.mass_usm_2*hypCP2^2;
...
fz = mean([fxy_1*tan(th1),fxy_2*tan(th2)]);
